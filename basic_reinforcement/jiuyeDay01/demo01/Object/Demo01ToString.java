package jiuyeDay01.demo01.Object;
...
public class Demo01ToString{
    public static void main(String[] args) {
        ...
        String s = p.toString();
        System.out.println(s);//Person@75412c2f | abc | Person{name=张三 ,age=18}

        //直接打印对象的名字,其实就是调用对象的toString  p=p.toString();
        System.out.println(p);//Person@5f150435 | abc | Person{name=张三 ,age=18}
